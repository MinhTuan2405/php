...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    2 => 
    array (
      0 => '{^(?|/admin/(?|users/([^/]++)(?|/edit(*:39)|(*:46))|c(?|ourses/([^/]++)(?|/edit(*:81)|(*:88))|ategories/([^/]++)(?|/edit(*:122)|(*:130)))|orders/([^/]++)(*:155))|/c(?|art/(?|([^/]++)(*:184)|buy/([^/]++)(*:204)|([^/]++)(*:220))|ourse/([^/]++)(?|/learn(*:252)|(*:260)))|/reset\\-password/([^/]++)(*:295)|/verify\\-email/([^/]++)/([^/]++)(*:335)|/storage/(.*)(*:356))/?$}sDu',
    ),
    3 => 
    array (
      39 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminUserController@exportCsv',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminUserController@exportCsv',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@index',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@index',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@create',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@create',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@store',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@store',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@edit',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@edit',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@update',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@update',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@destroy',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminCourseController@destroy',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\VNPayController@return',
        'controller' => 'App\\Http\\Controllers\\VNPayController@return',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'vnpay.return.public',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CategoryController@filter',
        'controller' => 'App\\Http\\Controllers\\CategoryController@filter',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\VNPayController@createPayment',
        'controller' => 'App\\Http\\Controllers\\VNPayController@createPayment',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'vnpay.create-payment',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CourseController@startLearning',
        'controller' => 'App\\Http\\Controllers\\CourseController@startLearning',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:701:"function () {
    // 1. Khởi tạo sitemap
    $sitemap = \\Spatie\\Sitemap\\Sitemap::create();

    // 2. Thêm các trang tĩnh
    $sitemap->add(\\Spatie\\Sitemap\\Tags\\Url::create(\'/\'));
    $sitemap->add(\\Spatie\\Sitemap\\Tags\\Url::create(\'/about\'));
    $sitemap->add(\\Spatie\\Sitemap\\Tags\\Url::create(\'/contact\'));

    // 3. Thêm các trang động (Khóa học/Sản phẩm) từ Database
    $courses = \\App\\Models\\Course::all();
    foreach ($courses as $course) {
        // Lưu ý: url phải là đường dẫn đầy đủ
        $sitemap->add(\\Spatie\\Sitemap\\Tags\\Url::create("/course/{$course->slug}"));
    }
